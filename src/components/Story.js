  ...
  return (
    ...
    <div className="story-frame shadow-lg border border-gray-200 rounded-lg overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center mb-8">My Journey to Tech</h2>
        ...
        <p className="text-xl text-gray-600 mt-4">
          This journey from education to tech is a testament to the transformative power of passion and community. The thrill of solving complex problems and the satisfaction of contributing to a community that thrives on innovation fuels my journey forward, one project at a time.
        </p>
      </div>
      </div>
    </section>
